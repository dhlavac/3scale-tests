...
def template(root_path):
    """Path to template"""
    return os.path.join(root_path, "load_testing/templates/template_user_key_query_20_40M.hf.yaml")
...
def test_user_key_20_40M(applications, prod_client, setup_benchmark):
    """
